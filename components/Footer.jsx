    ...
    <footer className="bg-ink text-white/80">
      <div className="max-w-wrap mx-auto px-6 py-12 grid gap-10 sm:grid-cols-2 md:grid-cols-4">
        <div className="sm:col-span-2">
          <p className="font-display font-bold text-xl text-white">AgroValley Farms</p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-white/70">
            <li>
              <a
                href="/visiting-card/agrovalley-farms-visiting-card.pdf"
                download="AgroValley-Farms-Visiting-Card.pdf"
      ...
      <div className="border-t border-white/10">
        <div className="max-w-wrap mx-auto px-6 py-5 flex flex-col sm:flex-row gap-2 justify-between text-xs text-white/50 font-mono">
          <span>&copy; {new Date().getFullYear()} AgroValley Farms. সর্বস্বত্ব সংরক্ষিত।</span>
