...
export const metadata = {
  title: "পণ্য ক্যাটালগ | Agro Valley Limited",
  description: "Agro Valley Limited-এর মাছ, ডিম, ফিড, ঔষধ ও ভেটেরিনারি সাপ্লাইয়ের পণ্য ক্যাটালগ।",
};
...
function inquiryUrl(category) {
  const message = encodeURIComponent(`আসসালামু আলাইকুম, Agro Valley Limited-এর ${category} সম্পর্কে জানতে চাই।`);
    ...
    <main>
      <section className="relative overflow-hidden pt-36 pb-20 md:pt-48 md:pb-28">
        ...
        <div className="max-w-wrap mx-auto px-6">
          <p className="font-mono text-xs tracking-[0.25em] uppercase text-brand-dark mb-4">Product Catalog · Agro Valley Limited</p>
          ...
          <p className="mt-6 max-w-2xl text-lg text-ink/70 leading-relaxed">মাছ, ডিম, ফিড, ঔষধ ও ভেটেরিনারি সাপ্লাই—Agro Valley Limited-এর সমন্বিত পণ্য ও সেবা এক জায়গায় দেখুন। মূল্য, স্টক ও পাইকারি কোটেশনের জন্য সরাসরি যোগাযোগ করুন।</p>
